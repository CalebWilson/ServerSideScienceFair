...
<div class="main-f">
	...
	<div class="form-s">
		<form action="Admin.php?view=session" method="post" >
			...
			<?php if (isset ($this->msgs['SessionNum'])) print ($this->msgs['SessionNum']) ?>
			...
			<?php if (isset ($this->msgs['StartTime'])) print ($this->msgs['StartTime']) ?>

			<!-- EndTime -->
			<label for="EndTime">Session end time:</label>
			<input type="datetime-local" id="EndTime" name="EndTime"
				value="<?php print ($this->fields["EndTime"]) ?>"><br>
			<?php if (isset ($this->msgs['EndTime'])) print ($this->msgs['EndTime']) ?>
